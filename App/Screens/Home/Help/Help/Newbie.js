...
import { CONTENTS } from '../../../../Constants/NewbieHelpData';
import { getImage } from '../../../../Themes/Images';

export default class NewbieHelp extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return(
            <View style={styles.container}>
                <ChildNavBar label="Dành cho người ít thời gian" onBack={() => this.props.navigation.goBack()} />
